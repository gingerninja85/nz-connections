...
<style>
  :global(*){box-sizing:border-box}:global(body){margin:0;background:#f7f7f4;color:#202624;font-family:Arial,Helvetica,sans-serif}:global(a){color:#135f50}main{max-width:1060px;margin:auto;padding:38px 28px 90px}.breadcrumb{font-size:13px;margin:0 0 28px;color:#69726e}.breadcrumb a{text-decoration:underline}h1{font-family:Georgia,'Times New Roman',serif;font-size:46px;letter-spacing:-.02em;margin:0 0 10px}.intro{font-size:18px;color:#58625e;margin:0 0 25px;line-height:1.55}.note{max-width:780px;background:#eef4f1;border-left:5px solid #176b5a;padding:17px 20px;margin:25px 0;display:flex;flex-direction:column;gap:6px;line-height:1.5}.note span{color:#46504c}.tabs{display:flex;border-bottom:1px solid #bfc6c1;margin-top:35px;flex-wrap:wrap}.tabs button{background:none;border:0;border-bottom:4px solid transparent;padding:12px 18px;cursor:pointer;font-size:15px;color:#40504a}.tabs button.active{border-color:#176b5a;color:#202624;font-weight:700}.alphabet{display:flex;flex-wrap:wrap;gap:4px;padding:22px 0}.alphabet button{background:#fff;border:1px solid #bfc6c1;width:34px;height:34px;color:#135f50;font-weight:700;cursor:pointer}.alphabet button:hover,.alphabet button.active{background:#176b5a;color:#fff;border-color:#176b5a}.filters{display:grid;grid-template-columns:1fr 180px 130px;gap:14px;padding:22px 0}.filters label{display:flex;flex-direction:column;gap:7px;font-size:13px;font-weight:700}.filters input,.filters select,.toolbar select{background:#fff;border:1px solid #909a95;padding:10px;font-size:15px;border-radius:3px}.toolbar{border-top:1px solid #cdd2ce;border-bottom:1px solid #cdd2ce;padding:14px 0;display:flex;justify-content:space-between;align-items:center;gap:20px;font-size:13px}.toolbar label{display:flex;gap:8px;align-items:center}.results{background:#fff}.row{display:grid;grid-template-columns:1fr 110px 100px;gap:20px;align-items:center;padding:17px 15px;border-bottom:1px solid #d5dad6;color:#202624;text-decoration:none}.row:hover{background:#f1f4f1}.row strong{font-size:16px;color:#135f50;text-decoration:underline}.row span{font-size:13px;color:#68726e}.row .published-title{font-size:11px;color:#89928e}.row>div:first-child{display:flex;flex-direction:column;gap:5px}.tender{grid-template-columns:1fr 1.3fr 100px;align-items:start}.tender dl{display:grid;grid-template-columns:1fr 1fr;gap:8px 16px;margin:0}.tender dt{font-size:11px;font-weight:700;color:#59635f}.tender dd{font-size:13px;margin:2px 0 0}.count{display:flex;align-items:baseline;gap:5px}.count b{font-family:Georgia,serif;font-size:25px}.view{justify-self:end;color:#135f50!important;font-weight:700}.empty{padding:35px 15px;color:#68726e}.error{color:#8b2d2d}.pagination{display:flex;justify-content:center;align-items:center;gap:5px;margin-top:24px;flex-wrap:wrap}.pagination button{min-width:36px;height:36px;padding:0 10px;border:1px solid #bfc6c1;background:#fff;color:#135f50;cursor:pointer}.pagination button.active{background:#176b5a;color:#fff;border-color:#176b5a}.pagination button:disabled{opacity:.45;cursor:not-allowed}.pagination span{padding:0 5px;color:#68726e}@media(max-width:760px){main{padding:25px 16px 60px}h1{font-size:36px}.filters{grid-template-columns:1fr}.row,.tender{grid-template-columns:1fr}.tender dl{grid-template-columns:1fr 1fr}.view{justify-self:start}.toolbar{align-items:flex-start;flex-direction:column}}
</style>